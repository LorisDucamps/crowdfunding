...
export default function Header() {
    ...
    return (
        <header
            className="relative flex justify-between items-center max-w-[1440px] mx-auto before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-[128px] before:bg-linear-gradient">
            {isOpen && <div className="fixed inset-0 h-full background-linear z-10 sm:hidden"></div>}
            ...
            <picture>
                ...
                <source media="(max-width: 640px)"
                        ...
                        type="image/jpg"/>
                <img src="/assets/img/hero-desktop.webp" alt="Visuel bannière bureau de travail"/>
            </picture>
